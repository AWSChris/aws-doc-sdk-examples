   ...
   "version": FLOW_VERSION
    ...
    if error_code is None:
        ...
        with pytest.raises(ClientError) as exc_info:
            flow_version.create_flow_version(bedrock_agent_client, FLOW_ID, VERSION_DESCRIPTION)
...
def test_delete_flow_version(make_stubber, error_code):
   ...
   "flowVersion": FLOW_VERSION
    ...
    if error_code is None:
        ...
        with pytest.raises(ClientError) as exc_info:
            flow_version.delete_flow_version(bedrock_agent_client, FLOW_ID, FLOW_VERSION)
        assert exc_info.value.response["Error"]["Code"] == error_code